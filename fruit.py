...
def get_data(folder_path):
    ...
    indices = []
    labels = []
    for idx, folder_name in enumerate(os.listdir(folder_path)[:34]):
...
# # printouts=[]
# # #******显示图片*******#
# # # img_filename=mpimg.imread('E:\\code\\fruits\\1_100.jpg')
# # # plt.imshow(img_filename) #显示图片
# # # plt.axis('off') # 不显示坐标轴
# # # plt.show()
#
# #Load Model from disk
...
#
#
# # img_filename="C:\\Users\\Admin\\Desktop\\picture\\ya.jpg"
